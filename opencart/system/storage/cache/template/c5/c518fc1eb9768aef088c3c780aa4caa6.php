...
/* admin/view/template/localisation/weight_class_form.twig */
class __TwigTemplate_7f44462f1bb497939215d486bc29cad8 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<div class=\"card-header\"><i class=\"fa-solid fa-pencil\"></i> ";
        ...
        echo "</div>
\t\t\t<div class=\"card-body\">
\t\t\t\t<form id=\"form-weight-class\" action=\"";
        // line 20
        echo ($context["save"] ?? null);
...
\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"weight_class_description[";
            ...
            echo "][title]\" value=\"";
            echo (((($__internal_compile_0 = ($context["weight_class_description"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 27)] ?? null) : null)) ? (twig_get_attribute($this->env, $this->source, (($__internal_compile_1 = ($context["weight_class_description"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1[twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 27)] ?? null) : null), "title", [], "any", false, false, false, 27)) : (""));
            echo "\" placeholder=\"";
            echo ($context["entry_title"] ?? null);
            echo "\" id=\"input-title-";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 27);
...
\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"weight_class_description[";
            ...
            echo "][unit]\" value=\"";
            echo (((($__internal_compile_2 = ($context["weight_class_description"] ?? null)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2[twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 39)] ?? null) : null)) ? (twig_get_attribute($this->env, $this->source, (($__internal_compile_3 = ($context["weight_class_description"] ?? null)) && is_array($__internal_compile_3) || $__internal_compile_3 instanceof ArrayAccess ? ($__internal_compile_3[twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 39)] ?? null) : null), "unit", [], "any", false, false, false, 39)) : (""));
            echo "\" placeholder=\"";
            echo ($context["entry_unit"] ?? null);
            echo "\" id=\"input-unit-";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 39);
...
\t\t\t\t\t<input type=\"hidden\" name=\"weight_class_id\" value=\"";
        // line 52
        echo ($context["weight_class_id"] ?? null);
        echo "\" id=\"input-weight-class-id\"/>
\t\t\t\t</form>
\t\t\t</div>
\t\t</div>
\t</div>
...
";
    ...
    {
        return "admin/view/template/localisation/weight_class_form.twig";
    }
    ...
    {
        return new Source("", "admin/view/template/localisation/weight_class_form.twig", "C:\\xampp\\htdocs\\opencart\\admin\\view\\template\\localisation\\weight_class_form.twig");
    }
}
